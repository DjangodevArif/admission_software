...
from PyQt5.QtWidgets import QMessageBox, QApplication, QFrame, QStackedWidget, QHBoxLayout, QLabel

from qfluentwidgets import (NavigationInterface, NavigationItemPosition, NavigationWidget, MessageBox,
                            isDarkTheme, setTheme, Theme, qrouter)
from qfluentwidgets import FluentIcon as FIF
from qframelesswindow import FramelessWindow, TitleBar
from component.home import HomeWidget
from component.print import PrintWidget
from component import resource
from database.db import engine, get_db
from database.models import Base, Students
...
class AvatarWidget(NavigationWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.avatar = QImage('resource/profile-logo.png').scaled(
...
class Window(FramelessWindow):
    ...
    def __init__(self):
        ...
        # self.homeInterface = Ui_MainWindow()
        self.homeInterface = HomeWidget('Home Interface', self)
        self.printInterface = PrintWidget('Print Interface', self)
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.printInterface, FIF.PRINT, 'Print')
    ...
    def initWindow(self):
        self.resize(900, 700)
        self.setWindowIcon(QIcon('resource/admission-logo.jpg'))
        self.setWindowTitle('Admission App')
    ...
    def showMessageBox(self):
        w = MessageBox(
            'HI',
            'We are going to customize this software',
            self
        )
